...
import com.lightniinja.wbi.searchfuncs.SearchAll;

public class CmdInfoAll implements CommandExecutor{
	@Override
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		ArrayList<String> res = s.searchAll(page);
		if(res.size() <= 0) {
		...
		for(String s2: res) {
			...
			switch (c.TYPE) {
				...
				case CHANGE_BREAK:
					...
					String blockname = c.BLOCK.toString();
				...
				case CHANGE_PLACE:
					...
					String blockname2 = c.BLOCK.toString();
				...
				case CHANGE_TNT:
					...
					String blockname3 = c.BLOCK.toString();
				...
				case CHANGE_WORLDEDIT:
					...
					String blockname4 = c.BLOCK.toString();
					String nbname = c.NEW.toString();
