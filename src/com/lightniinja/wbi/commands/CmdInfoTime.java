...
import com.lightniinja.wbi.searchfuncs.SearchTime;

public class CmdInfoTime implements CommandExecutor{
	@Override
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		SearchTime s = new SearchTime();
		int page = 0;
		if(args.length > 2) 
		...
		ArrayList<String> res = s.searchAll(page, args[0] + " " + args[1]);
		System.out.print("Searching for time strings like `" + args[0] + " " + args[1] + "`");
		if(res.size() <= 0) {
